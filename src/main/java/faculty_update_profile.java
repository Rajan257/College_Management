...
@WebServlet("/faculty_update_profile")
public class faculty_update_profile extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public faculty_update_profile() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (name == null || name.trim().isEmpty() || contactStr == null || contactStr.trim().isEmpty()) {
            ...
            out.println("<a href='faculty_update_profile.jsp'>Go Back</a>");
            return;
        }
        ...
        try {
            ...
            session.setAttribute("facultyName", name.trim());

            response.sendRedirect("faculty_profile.jsp?msg=Profile+updated+successfully");
