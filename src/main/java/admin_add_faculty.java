...
@WebServlet("/admin_add_faculty")
public class admin_add_faculty extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (uid == null || uid.trim().isEmpty() || name == null || name.trim().isEmpty()
            ...
            out.println("<a href='admin_add_faculty.jsp'>Go Back</a>");
            return;
        }
        ...
        try {
            ...
            ps = con.prepareStatement(
                    "INSERT INTO faculty_signup(uid, Name, Email, contact, password) VALUES(?,?,?,?,?)");
            ...
            response.sendRedirect("faculty_details.jsp?msg=Faculty+added+successfully");
